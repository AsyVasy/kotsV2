module.exports = function(connection) {
  ...
  const getByUser = function getUser_registered_community(clbk, id_user) {
    const sql =  "SELECT * FROM `user_registered_community` INNER JOIN `community` WHERE community.id_community = user_registered_community.id_community AND user_registered_community.id_user = ?";
